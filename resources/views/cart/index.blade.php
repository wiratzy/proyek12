...
<div class="card">
                ...
                <div class="col-md-8 cart">
                    <div class="title">
                        <div class="row">
                            ...
                            <div class="col align-self-center text-right ">total: {{ $cartq }}</div>
                        </div>
                    </div>    
                    @foreach ($cart as $item)
                    <div class="row border-top border-bottom">
                        <div class="row main align-items-center">
                            <div class="col-2"><img class="img-fluid" src="{{ asset('storage/'. $item->product->ImageURL) }}"></div>
                            <div class="col">
                                <div class="row text-muted">{{ $item->product->ProductCode }}</div>
    ...
    <a href="#" class="quantity-btn" onclick="incrementQuantity(event)">+</a>
                            ...
                            <div class="col" id="totalPrice">Rp. {{ number_format($item->product->Price, 0, ',', '.') }} <span class="close"><form id="formRemove" action="{{ route('cart.remove', $item->product) }}" method="post">
        @csrf
        @method('delete')
