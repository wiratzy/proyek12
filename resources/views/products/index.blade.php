...
<body class="antialiased">
    ...
    <section id="home" class="hero-section">
			<div class="background-container">
				<img src="{{ asset('adminlte') }}/dist/img/bgheadline.jpg" alt="" >
			</div>
      <div class="container">
            ...
            @foreach ($products as $product)
                <div class="col">
                    <div class="image-container">
                        <img src="{{ asset('storage/'. $product->ImageURL) }}" class="card-img-top h-50">
                        <div class="dark-overlay"></div>
                        <div class="button-overlay">
                            <!-- Add to Wishlist button with love icon -->
                            

                            <button type="button" class="btncolor " data-bs-toggle="modal" data-bs-target="#modal{{ $product->id }}">
                                Detail
                            </button>
                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal{{ $product->id }}Label">Product Details</h5>
