        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 flex-nowrap g-3  ms-1" >
            ...
            <div class="col">
                                    <div class="nft">
                                        ...
                                        <div class='creator'>
                                            <div class='wrapper'>
                                            <form id="formAdd" action="<?php echo e(route('wishlist.add', $item)); ?>" method="post" >
    <?php echo csrf_field(); ?>
    <?php echo method_field('post'); ?>
    <button  type="submit" class="btn">
        <i class="<?php echo e($item->isInWishlist() ? 'fas' : 'far'); ?> fa-heart"></i>
        <?php echo e($item->isInWishlist() ? '' : ''); ?>
...
<?php echo $__env->make('layouts.kategori', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Riski Firmansah\Documents\Skool\SEM 3\proyek12\resources\views/kategori/haircare.blade.php ENDPATH**/ ?>