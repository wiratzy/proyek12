...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/products/cart/update', [CartController::class, 'updateCart'])->name('tambahCart');
    Route::post('/products/cart/minus', [CartController::class, 'removeQty'])->name('kurangCart');
});
