...
<span class="brand-text font-weight-light">CRUD LARAVEL</span>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="/profil" class="d-block"><?php echo e(auth()->user()->name); ?></a>
            </div>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <?php echo e($slug == 'karyawan' ? 'active' : ''); ?>">
                        <i class="nav-icon fa fa-users" aria-hidden="true"></i>
                        <p>
                            Data Karyawan
                        </p>
...
<?php /**PATH C:\xampp\htdocs\proyek12\resources\views/layoutadmin/sidebar.blade.php ENDPATH**/ ?>